...
import torch
import time
from transformers import AutoTokenizer, AutoModelForCausalLM, pipeline#, LlamaForCausalLM,  GenerationConfig, Qwen2VLForConditionalGeneration, AutoProcessor
...
def create_chatbot(model_name: str, model_size: str, summerization: bool, history_saving: bool, history_calling: bool, multimodal: bool, language: str = "fr"):
    if "distill" in model_name:
        return LlamaDistillChatBot(model_name, model_size, summerization, history_saving, history_calling, multimodal, language)
...
class Qwen251MChatBot(LlamaChatBot):
    def load_models(self, model_size: str):
        self.model_id = f"Qwen/Qwen2.5-{model_size}-Instruct-1M"
